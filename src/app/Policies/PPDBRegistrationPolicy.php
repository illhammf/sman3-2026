...
class PPDBRegistrationPolicy
{
    ...
    {
        return $user->can('view_any_p::p::d::b::registration');
    }
    ...
    {
        return $user->can('view_p::p::d::b::registration');
    }
    ...
    {
        return $user->can('create_p::p::d::b::registration');
    }
    ...
    {
        return $user->can('update_p::p::d::b::registration');
    }
    ...
    {
        return $user->can('delete_p::p::d::b::registration');
    }
    ...
    {
        return $user->can('delete_any_p::p::d::b::registration');
    }
     ...
     */
    public function replicate(User $user, PPDBRegistration $pPDBRegistration): bool
    {
